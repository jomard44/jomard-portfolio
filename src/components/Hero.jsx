const Hero = () => {
  return (
    <section className="text-center py-24 px-4 max-w-4xl mx-auto">
      ...
      <h2 className="text-4xl md:text-5xl font-bold mb-4">Hi, I’m Jomard</h2>

      <p className="text-xl text-gray-700/70 mb-4">Full Stack Developer</p>

      <p className="text-gray-700/70 mb-6">
        I build web applications using React, Node.js, and MongoDB. I enjoy
        solving problems and turning ideas into real applications.
      </p>
